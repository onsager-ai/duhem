...
Acceptance criterion for Chreode's headless entry point: `pnpm chreode
...
Target: `onsager-ai/chreode`. Verified against the real factory pipeline
...
`pnpm chreode` binary and judges its exit code and output.
