...
- [breaking] Catalog-aware validation now rejects unregistered `uses:` values; attempted error/timeout steps make verdicts inconclusive, and the catalog adds page-free `ui/wait`. Migrate roadmap names or typos to registered actions. (#430, #431, #432)
