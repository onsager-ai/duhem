...
const TARGETS = [
  ['lovable', 'https://vf-demo-landing-page.lovable.app/'],
  ['lovable', 'https://doenkers-pagelens.lovable.app/'],
  ['lovable', 'https://onize-consult.lovable.app/'],
  ['lovable', 'https://emoba-93960.lovable.app/'],
  ['lovable', 'https://cryptofree.lovable.app/dashboard'],
  ['lovable', 'https://dealdaddy-pro-dashboard.lovable.app/'],
  ['lovable', 'https://cyberdem-visions.lovable.app/'],
  ['lovable', 'https://harrisaidashboard.lovable.app/'],
  ['lovable', 'https://prompt-directory-fh.lovable.app/'],
  ['lovable', 'https://daniel-brooks-shopify-experts.lovable.app/'],
  ['bolt', 'https://prospect-site-ai-moc-vefw.bolt.host/'],
  ['bolt', 'https://boltfaq.bolt.host/'],
  ['bolt', 'https://jira-project-app-dev-8kxq.bolt.host/'],
  ['bolt', 'https://consultant-partner-l-8wmy.bolt.host/'],
  ['bolt', 'https://altrix-digital-techn-3960.bolt.host/'],
  ['bolt', 'https://page-element-upload-zjl3.bolt.host/'],
  ['bolt', 'https://simple-team-project-djg1.bolt.host/'],
  ['bolt', 'https://sensory-branding-pac-x19y.bolt.host/'],
  ['bolt', 'https://nichefoundry-saas-bu-npf6.bolt.host/'],
  ['bolt', 'https://graphic-design-portf-xz9f.bolt.host/'],
  ['replit', 'https://uptimedash.replit.app/'],
  ['replit', 'https://jacks-sidekick.replit.app/'],
  ['replit', 'https://dash-bookmark.replit.app/'],
  ['replit', 'https://know-tools.replit.app/'],
  ['replit', 'https://site-audit-dashboard.replit.app/'],
  ['replit', 'https://mylifedashboard.replit.app/'],
  ['replit', 'https://ultimate-wedding-planner.replit.app/'],
  ['replit', 'https://markobra.replit.app/'],
  ['replit', 'https://asset-manager--rennzz.replit.app/'],
  ['replit', 'https://buildathons.replit.app/gallery'],
];
...
async function main() {
  ...
  for (const [gen, url] of TARGETS) {
    ...
    results.push(rec);
    fs.writeFileSync('out/phase5c.json', JSON.stringify(results, null, 2));
